...
error_fun = function(x, data, data_template,  plot=F, dpsi_data = dpsi_data,
...
get_parameters <- function(x){
  ...
  readr::write_csv(df,file=paste0("DATA/parameters_kmax/",stomatal_model_now,"_",species,"_",x$source,".csv"))
